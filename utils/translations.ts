...
export const translations = {
    en: {
        ...
        statFixed: "Repairs Completed",
        statActive: "Active Departments",
        statPending: "Pending Action",

        // Portal Cards
        cardCitizenTitle: "Citizen App",
        cardCitizenDesc: "Report road defects, track status, and view AI analysis.",
        cardDeptTitle: "Department Portal",
        cardDeptDesc: "Oversee jurisdiction, assign supervisors, and analyze data.",
        cardWardTitle: "Ward Operations",
        cardWardDesc: "Manage local repairs, verify contractor work, and update status.",

        // Actions
        btnEnter: "Enter Portal",
        btnLogin: "Login",
        btnUpload: "Submit Report",
        ...
        managedBy: "Website Content Managed by",
        rightsReserved: "All Rights Reserved.",
        designedBy: "Designed by RoadGuard.",

        // Footer Links
        roadSafety: "Road Safety",
        tollInfo: "Toll Information",
        highwayProjects: "Highway Projects",
        ...
        service1Title: "Capture & Upload",
        service1Desc: "Easily upload images or video of road defects. Our system automatically geotags and classifies the severity.",
        service2Title: "AI Diagnosis",
        service2Desc: "Advanced algorithms analyze the visual data to determine repair requirements and priority levels instantly.",
        service3Title: "Track Action Taken",
        service3Desc: "Receive real-time updates on the status of your reported issues and view 'Before/After' visual proof.",
